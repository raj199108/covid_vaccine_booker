...
from utils import generate_token_OTP_auto, check_and_book, beep, BENEFICIARIES_URL, WARNING_BEEP_DURATION, \
...
def main():
    ...
    try:
        ...
        if args.token:
            ...
            while token is None:
                token = generate_token_OTP_auto(mobile, base_request_header)
